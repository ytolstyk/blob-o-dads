...
// Two independent deterministic numbers in [0, 1) derived from the userId.
// Different multipliers keep magnitude and bearing from correlating.
...
// Returns a deterministic lat/lng offset for the user, bounded by
// MAX_OFFSET_METERS. Always the same vector for the same userId.
